...
/*
*
*  Se a classe principal não escanear o pacote ----> bootcamp.dio.Bradesco.cambios.services, 
*  O cliente Feign não se registra. Nota: Sempre verifique isso na classe de inicialização.
 * 
 * *************************************************************************************************************
 ...
 *A anotação @Value("${fixer.api.key}") também é uma forma de injeção de dependência, onde o valor é obtido da 
 *configuração.
 * 
